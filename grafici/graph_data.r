...
LIG_TOS_PIE_authors_full=read.csv("/home/alf/Scrivania/lav_ubu_grasso/newanalisys/full/LIG_TOS_PIE_authors_full.csv")
...
LIG_TOS_PIE_authors_native=read.csv("/home/alf/Scrivania/lav_ubu_grasso/newanalisys/native/LIG_TOS_PIE_authors_native.csv")
...
tabella_hash_LIG_cat_full=read.csv("tabella_hash_LIG_cat_full.csv")  
tabella_hash_TOS_cat_full=read.csv("tabella_hash_TOS_cat_native.csv")
tabella_hash_PIE_cat_full=read.csv("tabella_hash_PIE_cat_full.csv")

##########################
LIG_TOS_PIE_hash_full=read.csv("/home/alf/Scrivania/lav_ubu_grasso/newanalisys/full/LIG_TOS_PIE_hash_full.csv")
...
LIG_TOS_PIE_hash_full$NfreqTOS[5]=LIG_TOS_PIE_hash_full$NfreqTOS[5]-tabella_hash_TOS_cat_full$freq[which(tabella_hash_TOS_cat_full$hashtag=="#allertameteoTOS")]
...
ggsave("LIG_TOS_PIE_hash_full.png")

##########################################################################################################################################################à

tabella_hash_LIG_cat_native=read.csv("tabella_hash_LIG_cat_native.csv")  
tabella_hash_TOS_cat_native=read.csv("tabella_hash_TOS_cat_native.csv")
tabella_hash_PIE_cat_native=read.csv("tabella_hash_PIE_cat_native.csv")

LIG_TOS_PIE_hash_native=read.csv("/home/alf/Scrivania/lav_ubu_grasso/newanalisys/native/LIG_TOS_PIE_hash_native.csv")
...
# leave frequency #allertameteoTOS from other category wich was annotated
LIG_TOS_PIE_hash_native$NfreqTOS[5]=LIG_TOS_PIE_hash_native$NfreqTOS[5]-tabella_hash_TOS_cat_native$freq[which(tabella_hash_TOS_cat_native$hashtag=="#allertameteoTOS")]
...
mdat$category=gsub("others","Users",mdat$category)
ggplot(mdat, aes(gsub("Nfreq","#allertameteo",variable), Tweets, fill=category)) + geom_bar(stat="identity", position="dodge") + labs(x="Channel", y="Tweet(%)")+scale_fill_manual(values = rainbow(10)) +coord_flip()
ggsave("LIG_TOS_PIE_hash_native.png")
...
LIG_TOS_PIE_mentions_full=read.csv("/home/alf/Scrivania/lav_ubu_grasso/newanalisys/full/LIG_TOS_PIE_mentions_full.csv")
...
LIG_TOS_PIE_mentions_native=read.csv("/home/alf/Scrivania/lav_ubu_grasso/newanalisys/native/LIG_TOS_PIE_mentions_native.csv")
...
daily_stat_TOS=read.csv("/home/alf/Scrivania/lav_ubu_grasso/newanalisys/full/TOS_out/daily_stat_TOS.csv")
...
daily_stat_LIG=read.csv("/home/alf/Scrivania/lav_ubu_grasso/newanalisys/full/LIG_out/daily_stat_LIG.csv")
...
daily_stat_PIE=read.csv("/home/alf/Scrivania/lav_ubu_grasso/newanalisys/full/PIE_out/daily_stat_PIE.csv")
...
top_authors_TOS=read.csv("/home/alf/Scrivania/lav_ubu_grasso/newanalisys/full/TOS_out/top_authors_TOS.csv")
topfull_authors_retweeted_TOS=read.csv("/home/alf/Scrivania/lav_ubu_grasso/newanalisys/full/TOS_out/topfull_authors_retweeted_TOS.csv
topfull_message_retweeted_TOS=read.csv("/home/alf/Scrivania/lav_ubu_grasso/newanalisys/full/TOS_out/topfull_message_retweeted_TOS.csv
