...
analitic_native_LIG=native_channel(readRDS("data/analitic_full_LIG.rds"))
analitic_native_TOS=native_channel(readRDS("data/analitic_full_TOS.rds"))
analitic_native_PIE=native_channel(readRDS("data/analitic_full_PIE.rds")) 

saveRDS(analitic_native_LIG,"data/analitic_native_LIG.rds")
saveRDS(analitic_native_TOS,"data/analitic_native_TOS.rds")
saveRDS(analitic_native_PIE,"data/analitic_native_PIE.rds")
...
saveRDS(an_native_allertameteoLIG_institution,"data/an_native_allertameteoLIG_institution.rds")
saveRDS(an_native_allertameteoLIG_weather,"data/an_native_allertameteoLIG_weather.rds")
saveRDS(an_native_allertameteoLIG_media,"data/an_native_allertameteoLIG_media.rds")
saveRDS(an_native_allertameteoLIG_volunteer_NGO,"data/an_native_allertameteoLIG_volunteer_NGO.rds")
...
saveRDS(an_native_allertameteoTOS_institution,"data/an_native_allertameteoTOS_institution.rds")
saveRDS(an_native_allertameteoTOS_weather,"data/an_native_allertameteoTOS_weather.rds")
saveRDS(an_native_allertameteoTOS_media,"data/an_native_allertameteoTOS_media.rds")
saveRDS(an_native_allertameteoTOS_volunteer_NGO,"data/an_native_allertameteoTOS_volunteer_NGO.rds")
...
saveRDS(an_native_allertameteoPIE_institution,"data/an_native_allertameteoPIE_institution.rds")
saveRDS(an_native_allertameteoPIE_weather,"data/an_native_allertameteoPIE_weather.rds")
saveRDS(an_native_allertameteoPIE_media,"data/an_native_allertameteoPIE_media.rds")
saveRDS(an_native_allertameteoPIE_volunteer_NGO,"data/an_native_allertameteoPIE_volunteer_NGO.rds")
