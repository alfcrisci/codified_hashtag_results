...
table_post_mentions_retweet=read.csv("grafici/table_post_mentions_retweet_full.csv")
...
ggsave("retweets_table.png",width=15,dpi = 300)
...
ggsave("mentions_table.png",width=15,dpi = 300)
